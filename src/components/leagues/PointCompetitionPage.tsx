...
export function PointCompetitionPage({ id }: { id: number }) {
  ...
  const resetEnrollmentModal = () => { setSelected(new Set()); setTeamQuery(""); setImporting(false); setImportText(""); setImportPreview(null); setImportNotFound([]); setImportRetry([]); };
